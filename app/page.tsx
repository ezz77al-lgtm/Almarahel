...
import {
  ...
  BlogCard,
  CardGrid,
} from '@/components/sections/image-card';
...
const whyChooseUs = [
  {
    ...
    title: 'جودة مضمونة',
    description:
      'نستخدم مواد عالية الجودة ونلتزم بمعايير صارمة في جميع خدماتنا وأعمالنا.',
  },
  {
    icon: Clock,
    title: 'الالتزام بالمواعيد',
    description:
      'نحترم وقتك ونلتزم بالجدول الزمني المتفق عليه لكل خدمة ومشروع.',
  },
  {
    icon: Award,
    title: 'خبرة احترافية',
    description:
      'فريق متخصص في خدمات تنظيف الزجاج والواجهات، وتركيب السيراميك والبورسلان والرخام والموزايكو والدهانات الداخلية.',
  },
  {
    icon: Users,
    title: 'فريق مدرّب',
    description:
      'فنيون ومتخصصون مدرّبون على أحدث أساليب العمل والتقنيات والمواد المناسبة لكل خدمة.',
  },
];
...
const processSteps = [
  {
    ...
    description:
      'نقوم بمعاينة الموقع وتقييم المتطلبات لتحديد الخدمة المناسبة وتقديم عرض سعر دقيق.',
  },
  {
    icon: HardHat,
    title: 'التنفيذ',
    description:
      'ننفذ العمل بفريق متخصص ومواد عالية الجودة وفق طبيعة الخدمة ومتطلبات الموقع.',
  },
  {
    icon: Sparkles,
    title: 'المراجعة النهائية',
    description:
      'نراجع تفاصيل العمل ونتأكد من جودة التنفيذ والنظافة قبل التسليم.',
  },
  {
    icon: CheckCircle2,
    title: 'التسليم',
    description:
      'نسلم الخدمة في الموعد المتفق عليه مع الحرص على تحقيق أعلى مستوى من الجودة.',
  },
];

const benefits = [
  'معاينة مجانية وتقدير دقيق للتكلفة',
  'فريق متخصص لكل نوع من الخدمات',
  'مواد عالية الجودة ومناسبة لطبيعة العمل',
      ...
      <section className="bg-muted/30 py-20 sm:py-24">
        <div className="container-mw container-px">
          <SectionHeading
            ...
            description="نقدم مجموعة متنوعة من خدمات تنظيف الزجاج والواجهات، وتركيب السيراميك والبورسلان والرخام والموزايكو، والدهانات الداخلية."
          />
          ...
          <div className="mt-12 text-center">
            <Link
              href="/services"
              className="group inline-flex items-center gap-2 rounded-xl bg-primary px-7 py-3.5 text-base font-bold text-primary-foreground btn-press transition-all hover:bg-primary-dark"
            >
              عرض جميع الخدمات
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2 text-center">
            <Reveal>
              ...
              <p className="lead mt-5 text-pretty">
                شركة المراحل السريعة متخصصة في تنظيف الزجاج والواجهات،
                وتركيب السيراميك والبورسلان والرخام والموزايكو، والدهانات
                الداخلية، مع توفير خدمات التنظيف بعقود شهرية في جدة والمدينة
                المنورة.
              </p>

              <p className="mt-4 text-base leading-relaxed text-muted-foreground text-pretty">
                نعمل بفريق متخصص في كل مجال، ونلتزم بأعلى معايير الجودة
                والالتزام بالمواعيد. هدفنا تقديم نتائج احترافية تلبي احتياجات
                عملائنا في القطاعين السكني والتجاري.
              </p>

              <div className="mt-8 flex flex-wrap gap-3">
                <Link
                  href="/about"
                  className="group inline-flex items-center gap-2 rounded-xl bg-primary px-6 py-3 text-sm font-bold text-primary-foreground btn-press transition-all hover:bg-primary-dark"
                >
                  تعرف علينا أكثر
                ...
                <Link
                  href="/services"
                  className="inline-flex items-center gap-2 rounded-xl border border-border px-6 py-3 text-sm font-bold transition-colors hover:bg-muted"
                >
                  تصفح خدماتنا
                </Link>
              </div>
            ...
            <Reveal delay={0.2}>
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <div
                    key={i}
                    className="rounded-2xl border border-border bg-card p-6 text-center transition-all duration-300 hover:border-accent/40 hover:shadow-card"
                  >
      ...
      <section className="bg-primary-dark py-20 sm:py-24">
        <div className="container-mw container-px mb-12 text-center">
          ...
          <h2 className="font-display text-3xl font-bold text-white sm:text-4xl lg:text-5xl text-balance">
            مشاريع نفخر بتنفيذها في جدة والمدينة المنورة
          </h2>

          <p className="mx-auto mt-5 max-w-2xl text-lg text-white/60 text-pretty">
            نماذج من مشاريعنا وخدماتنا المنجزة وفق معايير الجودة والاهتمام
            بالتفاصيل.
          </p>
        </div>
        ...
        <div className="container-mw container-px mt-12 text-center">
          <Link
            href="/projects"
            className="group inline-flex items-center gap-2 rounded-xl border border-accent/30 bg-accent/10 px-7 py-3.5 text-base font-bold text-accent transition-colors hover:bg-accent/20"
          >
            عرض جميع المشاريع
            <ArrowUpLeft className="h-5 w-5 transition-transform duration-300 group-hover:-translate-x-1 group-hover:-translate-y-1" />
          </Link>
      ...
      <section className="section-pad">
        <div className="container-mw container-px">
          <SectionHeading
            ...
            description="نلتزم بمعايير عالية في كل خدمة ومشروع لضمان جودة التنفيذ ورضا عملائنا."
          />
      ...
      <section className="section-pad">
        <div className="container-mw container-px">
          <SectionHeading
            ...
            description="نتبع منهجية واضحة في كل خدمة ومشروع لضمان جودة النتيجة ورضا العميل."
          />
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <Reveal>
              <span className="eyebrow">
                <MapPin className="h-4 w-4" /> تغطية محلية
              </span>
              ...
              <p className="lead mt-5 text-pretty">
                ...
                فريقنا جاهز للوصول إلى موقعك حسب نطاق الخدمة وطبيعة الموقع
                واحتياجات العمل.
              </p>
      ...
      <section className="bg-muted/30 py-20 sm:py-24">
        <div className="container-mw container-px">
          <SectionHeading
            ...
            description="مقالات إرشادية لمساعدتك في فهم خدمات تنظيف الزجاج والواجهات، وتركيب السيراميك والبورسلان والرخام والموزايكو، والدهانات الداخلية."
          />
