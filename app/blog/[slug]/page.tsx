    ...
    <>
        ...
        <div className="container-mw container-px">
          <article className="mx-auto max-w-3xl">
            {article.content.map((section, i) => (
              <Reveal key={i}>
                <h2 className="mt-12 font-display text-2xl font-bold first:mt-0">
                  {section.heading}
                </h2>
            ...
            <div className="mt-12 rounded-2xl border border-border bg-primary p-6 text-center">
              <p className="text-white font-semibold">
                هل تحتاج هذه الخدمة في جدة أو المدينة المنورة؟
              </p>
              ...
              <div className="mt-5 flex flex-col items-center justify-center gap-3 sm:flex-row">
                <Link
                  href="/contact"
                  className="group inline-flex items-center gap-2 rounded-xl bg-accent px-6 py-3 text-sm font-bold text-accent-foreground btn-press transition-all hover:brightness-95"
                >
                  اطلب الخدمة
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 rounded-xl border border-accent/30 bg-accent/10 px-6 py-3 text-base font-bold text-accent transition-colors hover:bg-accent/20"
                >
      ...
      {relatedServices.length > 0 && (
        <section className="section-pad bg-muted/30">
          <div className="container-mw container-px">
            <SectionHeading
              eyebrow="خدمة ذات صلة"
              title="الخدمة المرتبطة بهذا المقال"
            />
