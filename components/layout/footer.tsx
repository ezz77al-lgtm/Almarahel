        ...
        <div className="grid gap-12 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="mt-5 text-sm leading-relaxed text-muted-foreground">
              شركة المراحل السريعة تقدم خدمات تنظيف الزجاج والواجهات،
              وتنظيف الواجهات التجارية، وتركيب السيراميك والبورسلان والرخام
              والموزايكو، والدهانات الداخلية في جدة والمدينة المنورة،
              مع توفير عقود تنظيف شهرية حسب احتياجات العملاء.
            </p>
            ...
            <ul className="space-y-4">
              <li>
                <a
                  ...
                  className="flex items-center gap-3 font-mono text-sm text-primary-foreground/60 transition-colors hover:text-accent"
                >
