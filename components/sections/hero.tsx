  ...
  return (
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden bg-primary-dark pt-20">
      ...
      <div className="absolute inset-0">
        ...
        <img
          src="/hero/hero1.webp"
          alt="مبانٍ وواجهات حديثة في جدة والمدينة المنورة"
      ...
      <div className="container-mw container-px relative z-10 py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          >
              المراحل السريعة         
              <span className="mt-5 block leading-[1.6] text-accent">
              تنظيف الزجاج وتركيب السيراميك والرخام والدهانات الداخلية
            </span>
          </motion.h1>
          ...
          <motion.p
            ...
            className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed sm:text-2xl text-white"
          >
من تنظيف الزجاج والواجهات التجارية إلى تركيب السيراميك والبورسلان والرخام والموزايكو والدهانات الداخلية، نقدم حلولًا احترافية للمحلات والمعارض والمطاعم والمقاهي والمراكز والمباني في جدة والمدينة المنورة، مع عقود تنظيف شهرية ودورية للمنشآت التجارية.          </motion.p>
